    ...
    return(
        <div className="header">
            ...
            <p className="headerDesc">
                Get reawarded for travles - unlock instant savings of 10% or more with a free Lamabooking account 
            </p>
            ...
            <div className="headerSearch">
                ...
                <span onClick={()=>setOpenData(!openDate)} className="headerSearchText"> {`${format(date[0].startDate,"MM/dd/yyyy")} to ${format(date[0].endDate,"MM/dd/yyyy")}`}</span>
               {openDate && <DateRange
              ...
              {openOptions && <div className="options">
                    ...
                    <div className="optionItem">
                        ...
                        <div className="optionCounter">
                        <button className="optionsCounterButton" onClick={()=>handleOption("children","d")}>-</button>
                    ...
                    <div className="optionItem">
                        ...
                        <div className="optionCounter">
                        <button className="optionsCounterButton" onClick={()=>handleOption("room","d")}>-</button>
